...
namespace Joker.BLL
{
    public class Info_deviceBLL
    {
        private readonly Info_deviceDAL dal = new Info_deviceDAL();
        public Info_deviceBLL()
        { }
        #region  BasicMethod
        /// <summary>
        /// 是否存在该记录
        ...
        /// 获得数据列表
        /// </summary>
        public List<Info_deviceModel> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Info_deviceModel> DataTableToList(DataTable dt)
        {
            List<Info_deviceModel> modelList = new List<Info_deviceModel>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Info_deviceModel model;
